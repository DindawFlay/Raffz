...
anu = await fetchJson(`https://betaapikey.herokuapp.com/api/kuis/tebakgambar?apikey=BetaBotz`)
anu = anu
ini_image = anu.image
jawaban = anu.jawaban
...
anu = await fetchJson(`https://betaapikey.herokuapp.com/api/kuis/caklontong?apikey=BetaBotz`)
jawaban = anu.result.jawaban
...
anu = await fetchJson(`https://betaapikey.herokuapp.com/api/yutub/audio?url=${url}&apikey=BetaBotz`)
...
url = args.join(' ')
reply(`Tunggu Butuh Beberapa Menit!`)
anu = await fetchJson(`https://betaapikey.herokuapp.com/api/yutub/video?url=${url}&apikey=BetaBotz`)
...
Ryuu.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Succes By : © Rijal Botz'})
break
case 'tiktokwm':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
if (isBanned) return reply('Kamu Sudah Di banned!')
...
reply(mess.wait)
get = await fetch.json(`https://betaapikey.herokuapp.com/api/github/stalk?username={body.slice(12)}&apikey=BetaBotz`)
...
Ryuu.sendMessage(from,buffer,{image: quoted mek,caption:teks})
break
case 'liriklagu':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!c) return reply('yg mau di cari apa?')
...
reply(mess.wait)
get = await fetchJson(`https://betaapikey.herokuapp.com/api/yutub/search?video={$url}&apikey=BetaBotz`)
reply(`${get.result}`)
break
